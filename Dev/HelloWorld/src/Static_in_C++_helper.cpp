...
// Another way to get around the linking error (ex: if in Static_in_C++.cpp, the s_Variable was defined as 'int s_Variable = 10') is to defined the variable in this file as:
